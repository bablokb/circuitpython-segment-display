...
class SegmentDisplay:
  ...
  def _set_digits(self,value,offsets):
    ...
    if rest < 10:
      ...
      d0 = (SegmentDisplay._NUMBERS[SegmentDisplay._NUM_MINUS]
            if is_neg else SegmentDisplay._NUMBERS[SegmentDisplay._NUM_WHITE])
    else:
  ...
  def _adjust_temperature(self,temp):
    ...
    if self._temp is not None:
      ...
      if (self._temp < 5 and temp < 5 or
          self._temp < 10 and temp < 10 or
          self._temp < 15 and temp < 15 or
          self._temp < 20 and temp < 20 or
          self._temp >= 20 and temp >= 20):
        return
      else:
        self._temp = temp
    else:
